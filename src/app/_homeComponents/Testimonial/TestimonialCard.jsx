...
const TestimonialCard = ({ name, image }) => {
  return (
    <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8 w-11/12 mx-auto ">
        ...
        <div>
          ...
          <div className="flex gap-1 mt-3">
            ...
            <div>
              ...
              <p
                className="text-violet-500 italic text-xs
              "
              >
                @jakghaas
              </p>
      ...
      <p className="mt-4 text-gray-700">
        ...
        really good job. I am glad I decided to work with you. Its really great
